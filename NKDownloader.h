...
//
/*
 使用的时候导入NKDownloadManager.h头文件，不是NKDownloader.h
 方便多下载任务管理
 */
 ...
 *  下载完成的通知名
 */
static NSString *const NKDownloadTaskDidFinishDownloadingNotification=@"NKDownloadTaskDidFinishDownloadingNotification";
/**
 *  系统存储空间不足的通知名
 */
static NSString *const NKInsufficientSystemSpaceNotification=@"NKInsufficientSystemSpaceNotification";
/**
 *  下载进度改变的通知
 */
static NSString *const NKProgressDidChangeNotificaiton=@"NKProgressDidChangeNotificaiton";
...
@interface NKDownloader : NSObject<NSURLConnectionDataDelegate,NSURLConnectionDelegate>
